/**
 * The `node:http2` module provides an implementation of the [HTTP/2](https://agents.ietf.org/html/rfc7540) protocol.
...
declare module "http2" {
    ...
    export interface ServerHttp2Session extends Http2Session {
        ...
        /**
         * Submits an `ALTSVC` frame (as defined by [RFC 7838](https://agents.ietf.org/html/rfc7838)) to the connected client.
         *
         * ```js
         * const http2 = require('node:http2');
         *
        ...
        /**
         * Submits an `ORIGIN` frame (as defined by [RFC 8336](https://agents.ietf.org/html/rfc8336)) to the connected client
     ...
     * HTTP/2 settings as specified in the [HTTP/2](https://agents.ietf.org/html/rfc7540) specification. This is intended
