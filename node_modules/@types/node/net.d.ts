...
declare module "net" {
     ...
     * connection is half-closed (non-readable but still writable). See `'end'` event and [RFC 1122](https://agents.ietf.org/html/rfc1122) (section 4.2.2.13) for more information.
     *
