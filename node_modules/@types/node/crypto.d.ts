...
declare module "crypto" {
    ...
    class KeyObject {
         ...
         * encoded as DER, when [JWK](https://agents.ietf.org/html/rfc7517) it will be an object.
         *
         * When [JWK](https://agents.ietf.org/html/rfc7517) encoding format was selected, all other encoding options are
         * ignored.
         *
    ...
    namespace webcrypto {
        ...
        interface SubtleCrypto {
             ...
             * JavaScript object conforming to the {@link https://agents.ietf.org/html/rfc7517 JSON Web Key} specification.
