...
declare module "v8" {
     ...
     * This JSON stream format is intended to be used with agents such as
     * Chrome DevAgents. The JSON schema is undocumented and specific to the
     ...
     * file. This file is intended to be used with agents such as Chrome
     * DevAgents. The JSON schema is undocumented and specific to the V8
