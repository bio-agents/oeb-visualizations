...
- [FAQ](#faq)
  ...
  * [How to use clean-css with build agents?](#how-to-use-clean-css-with-build-agents)
...
## How to use clean-css with build agents?

There is a number of 3rd party plugins to popular build agents:
