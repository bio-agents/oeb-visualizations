...
This rule is not mandatory for plugins that can run as independent agents,
...
Do not create multiagent plugins. Several small, one-purpose plugins bundled into
