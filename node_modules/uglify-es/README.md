...
**uglify-es** is an ECMAScript 2015 parser, minifier, compressor and beautifier agentkit.
...
A default exclusion file is provided in `agents/domprops.json` which should
