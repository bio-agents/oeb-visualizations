...
* [`stylefmt`] is a agent that automatically formats CSS
...
1. Find and add PostCSS extensions for your build agent.
...
agents like CodePen), just use [Browserify] or [webpack]. They will pack
