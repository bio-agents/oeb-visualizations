...
export interface SourceMapOptions {
   ...
   * Hi-res mappings map every single character, meaning (for example) your devagents will always
   * be able to pinpoint the exact location of function calls and so on.
   * With lo-res mappings, devagents may only be able to identify the correct
...
export class Bundle {
   ...
   * mechanism for agents to signal to debuggers that certain sources should be ignored by default
