...
var config = {
    ...
    /**
     * Whether to enable devagents
     */
    devagents: process.env.NODE_ENV !== 'production',
    /**
...
// detect devagents
var devagents = inBrowser && window.__VUE_DEVTOOLS_GLOBAL_HOOK__;
/* istanbul ignore next */
...
function flushSchedulerQueue() {
    ...
    // devagent hook
    /* istanbul ignore if */
    if (devagents && config.devagents) {
        devagents.emit('flush');
    }
}
...
function cloneAndMarkFunctionalResult(vnode, data, contextVm, options, renderContext) {
    ...
    if (process.env.NODE_ENV !== 'production') {
        (clone.devagentsMeta = clone.devagentsMeta || {}).renderContext =
            renderContext;
    }
    if (data.slot) {
...
// devagents global hook
/* istanbul ignore next */
if (inBrowser) {
    setTimeout(function () {
        if (config.devagents) {
            if (devagents) {
                devagents.emit('init', Vue);
            }
            else if (process.env.NODE_ENV !== 'production' && process.env.NODE_ENV !== 'test') {
                // @ts-expect-error
                console[console.info ? 'info' : 'log']('Download the Vue Devagents extension for a better development experience:\n' +
                    'https://github.com/vuejs/vue-devagents');
            }
        }
        if (process.env.NODE_ENV !== 'production' &&
